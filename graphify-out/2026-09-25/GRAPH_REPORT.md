...
## Corpus Check
- 3268 files · ~2,035,550 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2256 nodes · 5828 edges · 144 communities (98 shown, 43 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 70 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `21e4d41f`
...
Cohesion: 0.10
Nodes (26): BIOME_CONFIGS, BiomeAffinity, entryMatchesKeywords(), getBiomeCandidatePool(), UNIVERSAL_FALLBACK_KEYWORDS, UNIVERSAL_FALLBACK_TYPES, mockManifest, EncounterDifficulty (+18 more)

### Community 8 - "CoopTurnBar.tsx"
Cohesion: 0.40
Nodes (7): canSubmitPlayerTurn(), CoopTurnBar(), validatePlayerAction(), formatTypingMessage(), LiveTypingIndicator(), LiveTypingIndicatorProps, TypingUser
...
Cohesion: 0.09
Nodes (29): mapRegistry, OpenBattlemap, cityStreetPreset, dungeonPrisonPreset, forestAmbushPreset, gladiatorArenaPreset, ALL_PRESETS, getPresetByBiome() (+21 more)

### Community 11 - "lucide-react"
Cohesion: 0.13
Nodes (34): lucide-react, @radix-ui/react-slot, BestiaryBrowser(), BestiaryBrowserProps, CR_OPTIONS, CREATURE_TYPES, Props, BiomeCategory (+26 more)

### Community 12 - "DnDApp.tsx"
Cohesion: 0.06
Nodes (18): ArcState, ChatMessage, DnDApp(), handleGenerateStory(), startArcGeneration(), emptySubscribe(), formatInline(), getMessageError() (+10 more)

### Community 13 - "supabase/client.ts"
Cohesion: 0.11
Nodes (23): checkAllTables(), inspectCharactersSchema(), inspectData(), listCharacters(), listUsers(), GET(), POST(), POST() (+15 more)

### Community 14 - "RoomService"
Cohesion: 0.12
Nodes (16): verifyMultiplayerRoomFlow(), DELETE(), DELETE(), GET(), GET(), POST(), GET(), POST() (+8 more)

### Community 15 - "archetype-solver.ts"
Cohesion: 0.12
Nodes (27): BossMinionsCandidate, inferBacklineRole(), isFrontlineCandidate(), PackCandidate, RANGED_KEYWORDS, resolveArchetype(), solveBossMinions(), solveGreedyFallback() (+19 more)
...
Cohesion: 0.09
Nodes (15): CombatEndSummary, CombatViewProps, ELEMENT_TYPES, LOG_ICONS, ImportCharacterModal(), InitiativeTracker(), InitiativeTrackerProps, LibraryManagerModal() (+7 more)
...
Cohesion: 0.12
Nodes (19): CreateCampaignModal(), CreateCampaignModalProps, AttacksAbilitiesEditor(), save(), COST_OPTIONS, emptyAttack(), KIND_LABELS, Props (+11 more)

### Community 27 - "tools.ts"
Cohesion: 0.12
Nodes (23): StoryAct, advanceActTool, calculateTool, campaignContextSchema, characterUpdatesSchema, createCharacterTool, dmTools, fetchPageTool (+15 more)

### Community 28 - "getSupabaseBrowserClient"
Cohesion: 0.67
Nodes (3): testAuth(), useRoomRealtime(), getSupabaseBrowserClient()
...
### Community 33 - "bot.ts"
Cohesion: 0.14
Nodes (31): alliesOf(), bestAttack(), BotArchetype, BotStep, BotTurnResult, decideBotTurn(), determineFacingTowards(), evaluateTargetScore() (+23 more)

### Community 34 - "combat/types.ts"
Cohesion: 0.06
Nodes (35): WeaponProfile, BEAST_FORMS, BeastForm, getBeastFormById(), AttackOutcome, CombatState, createMockCombatState(), createTestCombatState() (+27 more)
...
Cohesion: 0.14
Nodes (22): main(), main(), main(), streamTurn(), main(), main(), main(), main() (+14 more)
...
### Community 40 - "vitest"
Cohesion: 0.14
Nodes (25): vitest, CoopTurnBarProps, PartyTurnBarProps, DIFFICULTY_OPTIONS, RoomCampaignSetupModal(), RoomCampaignSetupModalProps, SETTING_PRESETS, SITUATION_OPTIONS (+17 more)
...
Cohesion: 0.09
Nodes (31): sonner, ImportCharacterModalProps, COMMON_CONDITIONS, DAMAGE_TYPES, EditableLibraryItem, LibraryCategory, Props, AttackItem (+23 more)
...
### Community 46 - "combat/create/route.ts"
Cohesion: 0.33
Nodes (6): GET(), getHostPort(), getLanIps(), POST(), TEST_ENEMIES, TestEnemy
...
Cohesion: 0.09
Nodes (34): cheerio, SpawnedEnemy, DAMAGE_TYPE_MAP, normalizeDamageType(), parseAbilities(), parseAction(), parseCR(), parseDamageTypes() (+26 more)

### Community 81 - "db.ts"
Cohesion: 0.09
Nodes (29): @prisma/client, fetchSharedCharacter(), maxDuration, POST(), ShareFetchError, SHEET_BASE_URL, POST(), isEnemyDefeatedOrFled() (+21 more)
...
Cohesion: 0.13
Nodes (20): addDiceCount(), allyAdjacentTo(), CastContext, CastResult, findSneakAttack(), MoveOutcome, MultiattackResult, prepareDamage() (+12 more)
...
Cohesion: 0.10
Nodes (36): GET(), CombatGrid(), getCellFromEvent(), handleGlobalMouseMove(), handleGlobalMouseUp(), handleSvgClick(), handleSvgMouseMove(), handleSvgMouseUp() (+28 more)

### Community 126 - "room-service.ts"
Cohesion: 0.13
Nodes (18): @supabase/supabase-js, uuid, POST(), JoinRoomModal(), handleSubmit(), JoinRoomModalProps, CampaignSetupFormValues, PartyAwareAct1 (+10 more)
...
Cohesion: 0.17
Nodes (17): cleanAssistantNarrative(), maxDuration, POST(), { mockStreamText }, buildEphemeralSceneTail, EphemeralNpcState, EphemeralPartyMemberState, EphemeralRecentEvent (+9 more)

### Community 136 - "Combatant"
Cohesion: 0.12
Nodes (19): ClassifiedTargets, classifyAoeTargets(), DIRECTION_STEPS, DirStep, getConeCells(), getCubeCells(), getLineCells(), getSphereCells() (+11 more)
...
Cohesion: 0.14
Nodes (25): createHeroes(), ensureDir(), initCombat(), initDragonCombat(), loadSession(), main(), printStatus(), saveState() (+17 more)
...
- **Why does `vitest` connect `vitest` to `scene-synchronizer.ts`, `package.json`, `ai`, `react`, `generator.ts`, `chat/route.ts`, `CoopTurnBar.tsx`, `Combatant`, `maps/types.ts`, `DnDApp.tsx`, `supabase/client.ts`, `RoomService`, `party-arc-generator.ts`, `archetype-solver.ts`, `manual-combat-runner.ts`, `utils.ts`, `redirects.test.tsx`, `action/route.ts`, `d20-helper.ts`, `loot-generator.ts`, `AttacksAbilitiesEditor.tsx`, `library-data.ts`, `bot.ts`, `combat/types.ts`, `createClient`, `LibraryItemEditorModal.tsx`, `combat/create/route.ts`, `cost.ts`, `pacing-director.test.ts`, `open-map-service.ts`, `encounter-generator.ts`, `monster-adapter.ts`, `monsters/types.ts`, `db.ts`, `import-character/route.ts`, `engine.ts`, `CombatView`, `movement.ts`, `room-service.ts`, `validation.ts`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `Hotbar.tsx`, `drawer.tsx`, `switch.tsx`, `lucide-react`, `DnDApp.tsx`, `utils.ts`, `toggle-group.tsx`, `sidebar.tsx`, `AttacksAbilitiesEditor.tsx`, `alert-dialog.tsx`, `use-toast.ts`, `context-menu.tsx`, `navigation-menu.tsx`, `LibraryItemEditorModal.tsx`, `carousel.tsx`, `command.tsx`, `CharacterCard.tsx`, `form.tsx`, `resizable.tsx`, `accordion.tsx`, `chart.tsx`, `dropdown-menu.tsx`, `hover-card.tsx`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `Hotbar.tsx`, `package.json`, `drawer.tsx`, `switch.tsx`, `CoopTurnBar.tsx`, `lucide-react`, `DnDApp.tsx`, `utils.ts`, `toggle-group.tsx`, `CombatView.tsx`, `sidebar.tsx`, `AttacksAbilitiesEditor.tsx`, `alert-dialog.tsx`, `use-toast.ts`, `context-menu.tsx`, `navigation-menu.tsx`, `vitest`, `LibraryItemEditorModal.tsx`, `carousel.tsx`, `command.tsx`, `CharacterCard.tsx`, `form.tsx`, `resizable.tsx`, `accordion.tsx`, `chart.tsx`, `dropdown-menu.tsx`, `hover-card.tsx`, `cn`, `CombatView`, `movement.ts`, `room-service.ts`?**
