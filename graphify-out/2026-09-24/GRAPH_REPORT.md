# Graph Report - battle+ai  (2026-09-23)

## Corpus Check
- 6255 files · ~3,530,465 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3452 nodes · 8461 edges · 148 communities (125 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ac8f2f70`
...
- dependencies
- cn
- src/components/combat/LibraryItemEditorModal.tsx
- tools.ts
...
- CombatView
- src/lib/combat/monsters/types.ts
...
- BATTLE/src/lib/combat/monsters/types.ts
- CoopTurnBar.tsx
- src/app/layout.tsx
...
- BATTLE/src/components/combat/CombatGrid.tsx
- chat/route.ts
- BATTLE/src/components/combat/LibraryItemEditorModal.tsx
- room-service.ts
- manual-combat-runner.ts
- src/components/ui/dropdown-menu.tsx
- party-arc-generator.ts
- BATTLE/src/lib/combat/maps/spawn-director.ts
- src/lib/utils.ts
...
1. `cn()` - 232 edges
2. `cn()` - 232 edges
3. `Combatant` - 58 edges
4. `Combatant` - 49 edges
5. `CombatState` - 46 edges
6. `runBotTurn()` - 41 edges
7. `db` - 41 edges
8. `RoomService` - 39 edges
9. `CombatState` - 33 edges
10. `POST()` - 33 edges
...
### Community 0 - "generator.ts"
Cohesion: 0.13
Nodes (20): mockManifest, EncounterDifficulty, EncounterRequest, GeneratedEncounter, PartyMember, SquadArchetype, SquadMonsterSlot, SquadPlan (+12 more)

### Community 1 - "Combatant"
Cohesion: 0.06
Nodes (43): Props, COST_LABEL, HotbarProps, InitiativeTracker(), InitiativeTrackerProps, Props, PresetsModal(), RoleSelectorModalProps (+35 more)

### Community 2 - "package.json"
Cohesion: 0.02
Nodes (82): bun-types, cheerio, class-variance-authority, clsx, cmdk, date-fns, embla-carousel-react, eslint (+74 more)
...
### Community 5 - "BATTLE/src/lib/combat/movement.ts"
Cohesion: 0.17
Nodes (24): getActiveCombat(), printContext(), GET(), getSpellDefinition(), cellCost(), computeVisibilityStatus(), coversCell(), FACING_VECTORS (+16 more)
...
### Community 8 - "cn"
Cohesion: 0.04
Nodes (75): AccordionContent(), AccordionItem(), AccordionTrigger(), Avatar(), AvatarFallback(), AvatarImage(), BreadcrumbEllipsis(), BreadcrumbItem() (+67 more)

### Community 9 - "src/components/combat/LibraryItemEditorModal.tsx"
Cohesion: 0.09
Nodes (29): COMMON_CONDITIONS, DAMAGE_TYPES, EditableLibraryItem, LibraryCategory, LibraryItemEditorModal(), Props, AttackItem, Props (+21 more)

### Community 10 - "tools.ts"
Cohesion: 0.08
Nodes (33): POST(), StoryAct, advanceActTool, calculateTool, campaignContextSchema, characterUpdatesSchema, createCharacterTool, fetchPageTool (+25 more)

### Community 11 - "BATTLE/src/lib/combat/library-data.ts"
Cohesion: 0.05
Nodes (60): db, POST(), POST(), GET(), LibraryAbility, LibrarySpell, EditableLibraryItem, AbilityItem (+52 more)

### Community 12 - "src/components/combat/CombatView.tsx"
Cohesion: 0.08
Nodes (24): AttacksAbilitiesEditor(), save(), COST_OPTIONS, emptyAttack(), KIND_LABELS, Props, rebuildHotbar(), Tab (+16 more)
...
### Community 15 - "src/lib/combat/encounters/archetype-solver.ts"
Cohesion: 0.15
Nodes (23): dragons, manifest, MANIFEST_PATH, raw, BossMinionsCandidate, inferBacklineRole(), isFrontlineCandidate(), PackCandidate (+15 more)

### Community 16 - "BATTLE/src/lib/utils.ts"
Cohesion: 0.06
Nodes (22): Alert(), AlertDescription(), AlertTitle(), alertVariants, DrawerContent(), DrawerDescription(), DrawerFooter(), DrawerHeader() (+14 more)

### Community 17 - "BATTLE/src/lib/combat/bot.ts"
Cohesion: 0.15
Nodes (35): CombatantDetails(), damageSummary(), extractWeaponBase(), Hotbar(), spellSummary(), alliesOf(), bestAttack(), BotArchetype (+27 more)
...
### Community 19 - "MapPresetsModal.tsx"
Cohesion: 0.08
Nodes (40): BestiaryBrowser(), BestiaryBrowserProps, CR_OPTIONS, CREATURE_TYPES, InitiativeTracker(), InitiativeTrackerProps, BiomeCategory, MapPresetsModal() (+32 more)
...
### Community 21 - "src/lib/combat/engine.ts"
Cohesion: 0.11
Nodes (60): loadState(), POST(), respond(), saveState(), syncCharacterPotionConsumed(), getBeastFormById(), isBotTurn(), addDiceCount() (+52 more)

### Community 22 - "src/lib/combat/movement.ts"
Cohesion: 0.11
...
### Community 26 - "RoomLobby.tsx"
Cohesion: 0.10
Nodes (15): @supabase/supabase-js, testAuth(), SupabaseAuthModal(), SupabaseAuthModalProps, CharacterPickerModal(), CharacterPickerModalProps, formatCharacterCardForPicker(), FormattedCharacterCard (+7 more)

### Community 27 - "BATTLE/src/lib/combat/serialize.ts"
Cohesion: 0.09
Nodes (36): GET(), getHostPort(), getLanIps(), POST(), TEST_ENEMIES, TestEnemy, ABILITY_RU_TO_EN, DAMAGE_TYPE_RU (+28 more)

### Community 28 - "BATTLE/src/components/ui/dropdown-menu.tsx"
Cohesion: 0.12
...
Cohesion: 0.06
Nodes (45): POST(), LibraryAbility, LibrarySpell, AbilityItem, SpellItem, PresetsModalProps, SpellDefinitionLike, ABILITY_ALIASES (+37 more)
...
Cohesion: 0.11
Nodes (39): cleric, fighter, runSimulation(), wizard, alliesOf(), bestAttack(), BotArchetype, BotStep (+31 more)

### Community 34 - "RoomService"
Cohesion: 0.16
Nodes (10): verifyMultiplayerRoomFlow(), DELETE(), GET(), GET(), POST(), mapRoomFromDb(), resolveRoomTurn(), RoomService (+2 more)

### Community 35 - "sync-dndsu-bestiary.ts"
Cohesion: 0.21
Nodes (14): CACHE_DIR, CANONICAL_TYPES, CATALOG_CACHE_PATH, CatalogItem, CliOptions, COMPENDIUM_BASE_DIR, delay(), ensureDirectories() (+6 more)

### Community 36 - "BATTLE/src/lib/combat/engine.ts"
Cohesion: 0.07
Nodes (54): addDiceCount(), applyActionParameters(), CastContext, CastResult, checkSpellRange(), MoveOutcome, MultiattackResult, prepareDamage() (+46 more)

### Community 37 - "scene-synchronizer.ts"
Cohesion: 0.26
Nodes (11): AuthMode, CompactOptions, applyStatusToNotes(), extractJson(), extractStatusFromNotes(), SceneUpdate, sceneUpdateSchema, syncSceneState() (+3 more)
...
Cohesion: 0.06
Nodes (41): CombatState, checkLegendaryResistance(), performLegendaryAction(), triggerAILegendaryActions(), createMockCombatState(), crToProfBonus(), getAttackStem(), MonsterAdapterOptions (+33 more)
...
### Community 46 - "src/lib/combat/maps/spawn-director.ts"
Cohesion: 0.20
...
Cohesion: 0.10
Nodes (29): mapRegistry, cityStreetPreset, gladiatorArenaPreset, ALL_PRESETS, getPresetByBiome(), getPresetById(), PRESETS_BY_BIOME, PRESETS_BY_ID (+21 more)
...
Cohesion: 0.07
Nodes (40): mapRegistry, OpenBattlemap, astralRiftPreset, banditCampPreset, bridgeChasmPreset, CANONICAL_PRESETS_EXTENDED, castleCourtyardPreset, desertDunesPreset (+32 more)

### Community 54 - "CombatView"
Cohesion: 0.11
Nodes (26): CombatEffectsLayer(), CombatEffectsLayerProps, CombatView(), addCombatant(), applyMultiSpell(), cancelTargeting(), continueAfterBot(), doAction() (+18 more)

### Community 55 - "src/lib/combat/monsters/types.ts"
Cohesion: 0.09
Nodes (33): SpawnedEnemy, DAMAGE_TYPE_MAP, normalizeDamageType(), parseAbilities(), parseAction(), parseCR(), parseDamageTypes(), ParseMeta (+25 more)
...
### Community 59 - "CombatState"
Cohesion: 0.09
Nodes (21): DMAssistAction, evaluateCombatPacing(), PacingEvaluation, PacingThreatLevel, shouldTriggerEncounterRelief(), createMockState(), CombatState, checkLegendaryResistance() (+13 more)

### Community 60 - "src/lib/combat/rules.ts"
Cohesion: 0.08
Nodes (36): CombatantDetails(), COST_LABEL, damageSummary(), extractWeaponBase(), Hotbar(), HotbarProps, spellSummary(), Popover() (+28 more)

### Community 61 - "src/lib/combat/types.ts"
Cohesion: 0.06
Nodes (59): ABILITY_RU_TO_EN, DAMAGE_TYPE_RU, detectActionCost(), detectWeapon(), parseBonus(), parseDamageString(), POST(), WeaponProfile (+51 more)
...
### Community 68 - "src/lib/db.ts"
Cohesion: 0.07
Nodes (17): GET(), getHostPort(), getLanIps(), POST(), TEST_ENEMIES, TestEnemy, isEnemyDefeatedOrFled(), POST() (+9 more)

### Community 69 - "src/components/ui/chart.tsx"
Cohesion: 0.25
Nodes (9): ChartConfig, ChartContainer(), ChartContext, ChartContextProps, ChartLegendContent(), ChartTooltipContent(), getPayloadConfigFromPayload(), THEMES (+1 more)

### Community 70 - "BATTLE/src/app/api/combat/action/route.ts"
Cohesion: 0.17
...
### Community 75 - "BATTLE/src/lib/combat/encounters/encounter-generator.ts"
Cohesion: 0.14
Nodes (30): inferBacklineRole(), isFrontlineCandidate(), RANGED_KEYWORDS, resolveArchetype(), solveBossMinions(), solveGreedyFallback(), solvePack(), solveSoloBoss() (+22 more)

### Community 76 - "BATTLE/src/lib/combat/monsters/types.ts"
Cohesion: 0.11
Nodes (20): BossMinionsCandidate, PackCandidate, TacticalCandidate, GenerateEncounterOptions, createManifestEntry(), filterMonsters(), COMPENDIUM_DIR, MANIFEST_PATH (+12 more)

### Community 77 - "CoopTurnBar.tsx"
Cohesion: 0.36
...
### Community 107 - "DnDApp.tsx"
Cohesion: 0.05
Nodes (27): CombatEndSummary, CostStatsModal(), ArcState, ChatMessage, DnDApp(), copyRoomLink(), deleteCampaign(), handleGenerateStory() (+19 more)

### Community 109 - "BATTLE/src/lib/combat/monsters/monster-parser-engine.ts"
Cohesion: 0.20
Nodes (16): DAMAGE_TYPE_MAP, normalizeDamageType(), parseAbilities(), parseAction(), parseCR(), parseDamageTypes(), ParseMeta, parseMonsterHtml() (+8 more)
...
### Community 131 - "BATTLE/src/components/combat/CombatView.tsx"
Cohesion: 0.08
Nodes (27): Home(), AttacksAbilitiesEditor(), save(), COST_OPTIONS, emptyAttack(), KIND_LABELS, rebuildHotbar(), Tab (+19 more)

### Community 132 - "audit-combat-engine.ts"
Cohesion: 0.21
Nodes (10): AuditIssue, createCombatant(), createFreshState(), runAudit(), BEAST_FORMS, BeastForm, getBeastFormById(), createAuditCombatant() (+2 more)
...
### Community 134 - "BATTLE/src/components/combat/CombatGrid.tsx"
Cohesion: 0.13
Nodes (17): CombatEffectsLayer(), CombatEffectsLayerProps, CombatGrid(), getCellFromEvent(), handleGlobalMouseMove(), handleGlobalMouseUp(), handleSvgClick(), handleSvgMouseMove() (+9 more)

### Community 135 - "chat/route.ts"
Cohesion: 0.13
Nodes (20): clientWithCustomUrl, cost, customCost, cleanAssistantNarrative(), maxDuration, POST(), compactHistory(), inFlight (+12 more)

### Community 136 - "BATTLE/src/components/combat/LibraryItemEditorModal.tsx"
Cohesion: 0.10
Nodes (16): COMMON_CONDITIONS, DAMAGE_TYPES, LibraryCategory, LibraryItemEditorModal(), Props, Checkbox(), Select(), SelectContent() (+8 more)

### Community 137 - "room-service.ts"
Cohesion: 0.14
Nodes (21): POST(), CampaignSetupFormValues, DIFFICULTY_OPTIONS, RoomCampaignSetupModal(), RoomCampaignSetupModalProps, SETTING_PRESETS, SITUATION_OPTIONS, validateCampaignSetupInput() (+13 more)

### Community 140 - "manual-combat-runner.ts"
Cohesion: 0.20
Nodes (18): createHeroes(), ensureDir(), initCombat(), initDragonCombat(), loadSession(), main(), printStatus(), saveState() (+10 more)

### Community 141 - "src/components/ui/dropdown-menu.tsx"
Cohesion: 0.12
Nodes (9): DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuLabel(), DropdownMenuRadioItem(), DropdownMenuSeparator(), DropdownMenuShortcut(), DropdownMenuSubContent() (+1 more)
...
### Community 144 - "BATTLE/src/lib/combat/maps/spawn-director.ts"
Cohesion: 0.14
Nodes (13): mockManifest, EncounterRequest, dungeonPrisonPreset, forestAmbushPreset, assignTacticalSpawns(), BACKLINE_CLASSES, BOSS_KEYWORDS, createDefaultSpawnZones() (+5 more)

### Community 145 - "src/lib/utils.ts"
Cohesion: 0.10
Nodes (15): handleCopyInviteLink(), Alert(), AlertDescription(), AlertTitle(), alertVariants, HoverCardContent(), ResizableHandle(), ResizablePanelGroup() (+7 more)

### Community 146 - "BATTLE/src/components/ui/menubar.tsx"
Cohesion: 0.12
...
### Community 148 - "src/lib/combat/encounters/encounter-generator.ts"
Cohesion: 0.20
Nodes (14): main(), GET(), POST(), GET(), POST(), createCombatantStub(), createMonsterDefinitionFromManifest(), generateEncounter() (+6 more)

### Community 150 - "cn"
Cohesion: 0.03
Nodes (95): AccordionContent(), AccordionItem(), AccordionTrigger(), Avatar(), AvatarFallback(), AvatarImage(), BreadcrumbEllipsis(), BreadcrumbItem() (+87 more)

### Community 152 - "src/components/ui/drawer.tsx"
Cohesion: 0.18
Nodes (6): DrawerContent(), DrawerDescription(), DrawerFooter(), DrawerHeader(), DrawerOverlay(), DrawerTitle()

### Community 153 - "src/lib/combat/encounters/biome-matcher.ts"
Cohesion: 0.29
...
- **Why does `react-hook-form` connect `BATTLE/src/components/ui/form.tsx` to `package.json`, `src/components/ui/form.tsx`?**
  _High betweenness centrality (0.194) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `BATTLE/src/components/ui/alert-dialog.tsx`, `Combatant`, `BATTLE/src/components/combat/CombatView.tsx`, `BATTLE/src/components/ui/chart.tsx`, `BATTLE/src/components/ui/context-menu.tsx`, `BATTLE/src/components/combat/LibraryItemEditorModal.tsx`, `BATTLE/src/lib/utils.ts`, `BATTLE/src/components/ui/menubar.tsx`, `BATTLE/src/hooks/use-toast.ts`, `BATTLE/src/components/ui/carousel.tsx`, `BATTLE/src/components/ui/form.tsx`, `BATTLE/src/components/ui/dropdown-menu.tsx`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `src/components/ui/chart.tsx`, `src/components/combat/LibraryItemEditorModal.tsx`, `DnDApp.tsx`, `src/components/combat/CombatView.tsx`, `src/components/ui/dropdown-menu.tsx`, `src/lib/utils.ts`, `MapPresetsModal.tsx`, `src/hooks/use-toast.ts`, `src/components/ui/drawer.tsx`, `src/components/ui/carousel.tsx`, `src/lib/combat/rules.ts`, `src/components/ui/alert-dialog.tsx`, `src/components/ui/form.tsx`, `CharacterInventoryModal.tsx`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **What connects `$schema`, `style`, `rsc` to the rest of the system?**
  _987 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `generator.ts` be split into smaller, more focused modules?**
