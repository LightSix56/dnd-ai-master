...
## Corpus Check
- 3247 files · ~2,021,244 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2186 nodes · 5626 edges · 140 communities (93 shown, 44 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6f387d6a`
...
Cohesion: 0.18
Nodes (7): @radix-ui/react-popover, COST_LABEL, Popover(), PopoverContent(), PopoverTrigger(), CONDITION_EFFECTS, DAMAGE_TYPE_LABELS

### Community 1 - "cn"
Cohesion: 0.05
Nodes (50): input-otp, @radix-ui/react-accordion, @radix-ui/react-avatar, @radix-ui/react-menubar, @radix-ui/react-radio-group, AccordionContent(), AccordionItem(), AccordionTrigger() (+42 more)
...
### Community 4 - "AttacksAbilitiesEditor.tsx"
Cohesion: 0.12
Nodes (21): @radix-ui/react-slot, AttacksAbilitiesEditor(), save(), COST_OPTIONS, emptyAttack(), KIND_LABELS, rebuildHotbar(), Tab (+13 more)

### Community 5 - "DnDApp.tsx"
Cohesion: 0.05
Nodes (28): CostStatsModal(), CostStatsModalProps, ArcState, ChatMessage, DnDApp(), copyRoomLink(), handleGenerateStory(), startArcGeneration() (+20 more)

### Community 6 - "Cell"
Cohesion: 0.15
Nodes (14): classifyAoeTargets(), DIRECTION_STEPS, DirStep, getConeCells(), getCubeCells(), getLineCells(), getSphereCells(), SphereOptions (+6 more)
...
Cohesion: 0.10
Nodes (28): canSubmitPlayerTurn(), CoopTurnBar(), CoopTurnBarProps, validatePlayerAction(), formatTypingMessage(), LiveTypingIndicator(), LiveTypingIndicatorProps, TypingUser (+20 more)
...
### Community 10 - "proficiencyBonus"
Cohesion: 0.12
Nodes (21): fetchSharedCharacter(), maxDuration, POST(), ShareFetchError, SHEET_BASE_URL, POST(), calculateTool, createCharacterTool (+13 more)

### Community 11 - "createClient"
Cohesion: 0.20
Nodes (11): main(), extractJson(), main(), main(), clientWithCustomUrl, cost, customCost, createClient() (+3 more)

### Community 12 - "maps/types.ts"
Cohesion: 0.21
Nodes (13): OpenBattlemap, BiomeType, SpawnZoneDefinition, UniversalVTT, UVTTLight, UVTTPoint, UVTTPortal, UVTTResolution (+5 more)

### Community 13 - "LibraryManagerModal.tsx"
Cohesion: 0.14
Nodes (27): LibraryCategory, D20RollModal(), executeRoll(), handleAttackRoll(), handleCustomRoll(), handleSaveRoll(), handleSkillRoll(), Input() (+19 more)

### Community 14 - "RoomService"
Cohesion: 0.16
Nodes (11): verifyMultiplayerRoomFlow(), DELETE(), GET(), POST(), handleSubmit(), normalizeRoomCode(), getActiveTurn(), mapParticipantFromDb() (+3 more)

### Community 15 - "archetype-solver.ts"
Cohesion: 0.19
Nodes (20): BossMinionsCandidate, inferBacklineRole(), isFrontlineCandidate(), PackCandidate, RANGED_KEYWORDS, resolveArchetype(), solveBossMinions(), solveGreedyFallback() (+12 more)
...
Cohesion: 0.11
Nodes (30): lucide-react, BestiaryBrowser(), BestiaryBrowserProps, CR_OPTIONS, CREATURE_TYPES, CombatEndSummary, CombatViewProps, ELEMENT_TYPES (+22 more)
...
Cohesion: 0.19
Nodes (39): runSimulation(), loadState(), POST(), respond(), saveState(), syncCharacterPotionConsumed(), isBotTurn(), applyActionParameters() (+31 more)

### Community 22 - "movement.ts"
Cohesion: 0.09
Nodes (41): GET(), CombatGrid(), getCellFromEvent(), handleGlobalMouseMove(), handleGlobalMouseUp(), handleSvgClick(), handleSvgMouseMove(), handleSvgMouseUp() (+33 more)
...
Cohesion: 0.12
Nodes (16): allCombatSpellsList, expandedList, getAllSpells, getSpell, monstersByName, monstersByNameEn, monstersList, searchSpells (+8 more)
...
### Community 33 - "bot.ts"
Cohesion: 0.12
Nodes (41): CombatantDetails(), damageSummary(), extractWeaponBase(), Hotbar(), spellSummary(), alliesOf(), bestAttack(), BotArchetype (+33 more)

### Community 34 - "room-service.ts"
Cohesion: 0.20
Nodes (11): @supabase/supabase-js, POST(), PartyAwareAct1, DND_ROOM_WORDS, generateRoomCode(), isValidRoomCode(), resolveRoomTurn(), startRoomCampaign() (+3 more)
...
Cohesion: 0.23
Nodes (13): POST(), GET(), POST(), buildFrozenRoomSystemPrompt(), resolveActiveRoomTurnHelper(), ResolveActiveRoomTurnOptions, bundleTurnInputs(), BundleTurnOptions (+5 more)
...
### Community 42 - "react"
Cohesion: 0.11
Nodes (25): react, sonner, ImportCharacterModal(), ImportCharacterModalProps, COMMON_CONDITIONS, DAMAGE_TYPES, Props, calculateBaseStats() (+17 more)
...
### Community 54 - "monster-adapter.ts"
Cohesion: 0.07
Nodes (41): CombatEffectsLayer(), CombatEffectsLayerProps, CombatView(), addCombatant(), applyMultiSpell(), cancelTargeting(), continueAfterBot(), doAction() (+33 more)
...
Cohesion: 0.11
Nodes (22): zustand, CharacterInventoryModal(), handleAddPotion(), handleDrinkPotion(), CharacterInventoryModalProps, createUniqueId(), getSyncTimestamp(), InventoryGear (+14 more)

### Community 60 - "engine.ts"
Cohesion: 0.11
Nodes (36): addDiceCount(), allyAdjacentTo(), CastResult, findSneakAttack(), MultiattackResult, prepareDamage(), scaleDice(), ShoveOutcome (+28 more)

### Community 61 - "serialize.ts"
Cohesion: 0.17
Nodes (16): GET(), getHostPort(), getLanIps(), GET(), POST(), GET(), getPresetById(), DEFAULT_SPELLS (+8 more)
...
Cohesion: 0.05
Nodes (44): TestEnemy, WeaponProfile, Props, InitiativeTrackerProps, Props, RoleSelectorModalProps, WildShapeModalProps, ClassifiedTargets (+36 more)
...
### Community 68 - "vitest"
Cohesion: 0.14
Nodes (13): @prisma/client, vitest, { mockStreamText }, POST(), TEST_ENEMIES, isEnemyDefeatedOrFled(), POST(), GET() (+5 more)
...
Cohesion: 0.17
Nodes (16): main(), GET(), createCombatantStub(), createMonsterDefinitionFromManifest(), generateEncounter(), GenerateEncounterOptions, loadDefaultManifest(), loadMonsterDefinition() (+8 more)
...
Cohesion: 0.13
Nodes (16): SpawnedEnemy, createManifestEntry(), filterMonsters(), COMPENDIUM_DIR, MANIFEST_PATH, mockEntries, CreatureSize, MonsterAbilities (+8 more)
...
Cohesion: 0.12
Nodes (24): startCombatTool, BIOME_CONFIGS, BiomeAffinity, entryMatchesKeywords(), getBiomeCandidatePool(), UNIVERSAL_FALLBACK_KEYWORDS, UNIVERSAL_FALLBACK_TYPES, mockManifest (+16 more)
...
Cohesion: 0.15
Nodes (23): createHeroes(), ensureDir(), initCombat(), initDragonCombat(), loadSession(), main(), printStatus(), saveState() (+15 more)
...
- **Why does `vitest` connect `vitest` to `package.json`, `DnDApp.tsx`, `Cell`, `chat/route.ts`, `room/types.ts`, `presets/index.ts`, `maps/types.ts`, `manual-combat-runner.ts`, `RoomService`, `party-arc-generator.ts`, `archetype-solver.ts`, `LibraryManagerModal.tsx`, `movement.ts`, `loot-generator.ts`, `preset-data.ts`, `spawn-director.ts`, `bot.ts`, `room-service.ts`, `library-data.ts`, `resolve-turn-helper.ts`, `models.ts`, `react`, `TacticalMapPreset`, `system-prompt.ts`, `pacing-director.test.ts`, `open-map-service.ts`, `monster-adapter.ts`, `monster-parser-engine.ts`, `mage-3rd-level-spells.test.ts`, `combat/types.ts`, `ai`, `encounter-generator.ts`, `monsters/types.ts`, `supabase/client.ts`, `scene-synchronizer.ts`, `generator.ts`, `validation.ts`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `Hotbar.tsx`, `package.json`, `AttacksAbilitiesEditor.tsx`, `DnDApp.tsx`, `room/types.ts`, `LibraryManagerModal.tsx`, `toggle-group.tsx`, `CombatView.tsx`, `sidebar.tsx`, `alert-dialog.tsx`, `use-toast.ts`, `context-menu.tsx`, `react`, `command.tsx`, `carousel.tsx`, `CharacterInventoryModal.tsx`, `form.tsx`, `chart.tsx`, `dropdown-menu.tsx`, `drawer.tsx`, `navigation-menu.tsx`, `resizable.tsx`, `hover-card.tsx`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `Hotbar.tsx`, `cn`, `package.json`, `AttacksAbilitiesEditor.tsx`, `DnDApp.tsx`, `room/types.ts`, `LibraryManagerModal.tsx`, `toggle-group.tsx`, `CombatView.tsx`, `movement.ts`, `sidebar.tsx`, `alert-dialog.tsx`, `use-toast.ts`, `context-menu.tsx`, `command.tsx`, `monster-adapter.ts`, `carousel.tsx`, `CharacterInventoryModal.tsx`, `form.tsx`, `chart.tsx`, `dropdown-menu.tsx`, `drawer.tsx`, `navigation-menu.tsx`, `useSupabaseAuth`, `resizable.tsx`, `hover-card.tsx`?**
