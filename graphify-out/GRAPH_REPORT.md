...
## Corpus Check
- 3254 files · ~2,025,759 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2206 nodes · 5688 edges · 142 communities (97 shown, 42 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 70 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4c4d1a04`
...
5. `RoomService` - 48 edges
6. `lucide-react` - 47 edges
7. `runBotTurn()` - 46 edges
8. `CombatState` - 46 edges
9. `db` - 46 edges
10. `POST()` - 39 edges
...
Cohesion: 0.13
Nodes (14): @radix-ui/react-popover, COST_LABEL, damageSummary(), extractWeaponBase(), Hotbar(), HotbarProps, spellSummary(), Popover() (+6 more)
...
Cohesion: 0.10
Nodes (20): @radix-ui/react-avatar, ArcState, ChatMessage, copyRoomLink(), emptySubscribe(), formatInline(), MarkdownRenderer(), StoryAct (+12 more)

### Community 5 - "RoomLobby.tsx"
Cohesion: 0.13
Nodes (12): @supabase/supabase-js, testAuth(), SupabaseAuthModal(), SupabaseAuthModalProps, CreateRoomModal(), CreateRoomModalProps, RoomLobby(), handleCopyInviteLink() (+4 more)

### Community 6 - "generator.ts"
Cohesion: 0.19
Nodes (12): POST(), TEST_ENEMIES, TestEnemy, GET(), startCombatTool, createTacticalEncounter(), EnemyInput, EnvironmentType (+4 more)

### Community 7 - "maps/types.ts"
Cohesion: 0.19
Nodes (15): GeneratedMapElement, OpenBattlemap, BiomeType, MapTagQuery, SpawnZoneDefinition, UniversalVTT, UVTTLight, UVTTPoint (+7 more)
...
Cohesion: 0.08
Nodes (35): @radix-ui/react-slot, AttacksAbilitiesEditor(), save(), COST_OPTIONS, emptyAttack(), KIND_LABELS, Props, rebuildHotbar() (+27 more)

### Community 12 - "DnDApp"
Cohesion: 0.08
Nodes (8): DnDApp(), handleGenerateStory(), startArcGeneration(), getMessageError(), getMessageText(), AutoScrollChatOptions, shouldAutoScrollChat(), shouldSyncCampaignSettings()
...
Cohesion: 0.20
Nodes (9): verifyMultiplayerRoomFlow(), DELETE(), DELETE(), GET(), GET(), POST(), mapParticipantFromDb(), mapRoomFromDb() (+1 more)
...
Cohesion: 0.11
Nodes (21): LibraryCategory, LibraryManagerModal(), Props, WildShapeModal(), WildShapeModalProps, CategoryFilter, ModelOption, ModelPickerModal() (+13 more)
...
Cohesion: 0.19
Nodes (35): loadState(), POST(), respond(), saveState(), syncCharacterPotionConsumed(), isBotTurn(), applyEffect(), assertTurn() (+27 more)
...
Cohesion: 0.05
Nodes (56): fetchSharedCharacter(), maxDuration, POST(), ShareFetchError, SHEET_BASE_URL, ABILITY_RU_TO_EN, DAMAGE_TYPE_RU, detectActionCost() (+48 more)

### Community 28 - "spawn-director.ts"
Cohesion: 0.23
Nodes (11): POST(), getPresetById(), assignTacticalSpawns(), BACKLINE_CLASSES, BOSS_KEYWORDS, createDefaultSpawnZones(), findClosestPassableCell(), inferCombatantRole() (+3 more)
...
### Community 33 - "bot.ts"
Cohesion: 0.14
Nodes (40): GET(), alliesOf(), bestAttack(), BotArchetype, BotStep, BotTurnResult, determineFacingTowards(), evaluateTargetScore() (+32 more)

### Community 34 - "Combatant"
Cohesion: 0.08
Nodes (25): CombatState, checkLegendaryResistance(), performLegendaryAction(), triggerAILegendaryActions(), createMockCombatState(), checkMoraleTrigger(), getFleeingDestination(), MoraleTriggerCheck (+17 more)
...
Cohesion: 0.20
Nodes (11): main(), main(), buildArcSection(), buildSystemPrompt(), difficultyDescriptions, dmStyleDescriptions, partyTiesDescriptions, PlayerSummary (+3 more)
...
Cohesion: 0.16
Nodes (17): POST(), GET(), POST(), buildFrozenRoomSystemPrompt(), resolveActiveRoomTurnHelper(), ResolveActiveRoomTurnOptions, ResolveActiveRoomTurnResult, getActiveTurn() (+9 more)

### Community 41 - "models.ts"
Cohesion: 0.12
Nodes (13): clientWithCustomUrl, cost, customCost, maxDuration, calculateCostRub(), KNOWN_MODEL_PRICING, CHEAP_MODEL, DEFAULT_CHEAP_MODEL (+5 more)

### Community 42 - "react"
Cohesion: 0.13
Nodes (24): lucide-react, react, sonner, ImportCharacterModalProps, COMMON_CONDITIONS, DAMAGE_TYPES, Props, calculateBaseStats() (+16 more)
...
Cohesion: 0.21
Nodes (14): main(), main(), streamTurn(), main(), extractJson(), main(), main(), main() (+6 more)
...
Cohesion: 0.14
Nodes (26): CombatantDetails(), ActionCostCheck, AdvantageResult, AttackResolution, computeAttackAdvantage(), DamageResult, DeathSaveResult, effectiveAC() (+18 more)

### Community 61 - "serialize.ts"
Cohesion: 0.27
Nodes (12): GET(), getHostPort(), getLanIps(), DEFAULT_SPELLS, hydrateCombat(), hydrateCombatant(), hydrateMapElement(), normalizeAttack() (+4 more)
...
Cohesion: 0.11
Nodes (25): crToProfBonus(), getAttackStem(), MonsterAdapterOptions, monsterDefinitionToCombatant(), parseCountBeforeStem(), parseMultiattack(), safeId(), ABILITY_LABELS (+17 more)
...
Cohesion: 0.22
Nodes (13): main(), createCombatantStub(), generateEncounter(), mockManifest, EncounterDifficulty, EncounterRequest, GeneratedEncounter, PartyMember (+5 more)
...
### Community 81 - "vitest"
Cohesion: 0.13
Nodes (11): @prisma/client, vitest, POST(), { mockStreamText }, isEnemyDefeatedOrFled(), POST(), awardCombatVictoryXP(), AwardCombatXPResult (+3 more)
...
Cohesion: 0.09
Nodes (33): BEAST_FORMS, BeastForm, getBeastFormById(), addDiceCount(), applyActionParameters(), AttackOutcome, CastContext, CastResult (+25 more)
...
Cohesion: 0.10
Nodes (20): CombatGrid(), getCellFromEvent(), handleGlobalMouseMove(), handleGlobalMouseUp(), handleSvgClick(), handleSvgMouseMove(), handleSvgMouseUp(), cellKey() (+12 more)

### Community 126 - "room-service.ts"
Cohesion: 0.12
Nodes (22): POST(), CampaignSetupFormValues, DIFFICULTY_OPTIONS, RoomCampaignSetupModal(), RoomCampaignSetupModalProps, SETTING_PRESETS, SITUATION_OPTIONS, validateCampaignSetupInput() (+14 more)
...
- **Why does `vitest` connect `vitest` to `monster-parser-engine.ts`, `package.json`, `ai`, `DnDApp.tsx`, `generator.ts`, `chat/route.ts`, `CoopTurnBar.tsx`, `maps/types.ts`, `presets/index.ts`, `DnDApp`, `supabase/client.ts`, `RoomService`, `party-arc-generator.ts`, `archetype-solver.ts`, `manual-combat-runner.ts`, `action/route.ts`, `d20-helper.ts`, `loot-generator.ts`, `preset-data.ts`, `library-data.ts`, `bot.ts`, `Combatant`, `system-prompt.ts`, `TacticalMapPreset`, `resolve-turn-helper.ts`, `models.ts`, `react`, `spawn-director.test.ts`, `pacing-director.test.ts`, `open-map-service.ts`, `aoe-templates.ts`, `rules.ts`, `combat/types.ts`, `JoinRoomModal.tsx`, `encounter-generator.ts`, `monsters/types.ts`, `scene-synchronizer.ts`, `biome-matcher.ts`, `engine.ts`, `CombatView`, `movement.ts`, `room-service.ts`, `validation.ts`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `Hotbar.tsx`, `package.json`, `drawer.tsx`, `DnDApp.tsx`, `RoomLobby.tsx`, `CoopTurnBar.tsx`, `CombatView.tsx`, `DnDApp`, `toggle-group.tsx`, `LibraryManagerModal.tsx`, `sidebar.tsx`, `alert-dialog.tsx`, `use-toast.ts`, `context-menu.tsx`, `navigation-menu.tsx`, `carousel.tsx`, `CharacterInventoryModal.tsx`, `form.tsx`, `input-otp.tsx`, `JoinRoomModal.tsx`, `accordion.tsx`, `chart.tsx`, `dropdown-menu.tsx`, `hover-card.tsx`, `cn`, `CombatView`, `movement.ts`, `room-service.ts`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `Hotbar.tsx`, `drawer.tsx`, `package.json`, `DnDApp.tsx`, `CombatView.tsx`, `toggle-group.tsx`, `LibraryManagerModal.tsx`, `sidebar.tsx`, `alert-dialog.tsx`, `use-toast.ts`, `context-menu.tsx`, `navigation-menu.tsx`, `react`, `carousel.tsx`, `CharacterInventoryModal.tsx`, `form.tsx`, `input-otp.tsx`, `accordion.tsx`, `chart.tsx`, `dropdown-menu.tsx`, `hover-card.tsx`?**
